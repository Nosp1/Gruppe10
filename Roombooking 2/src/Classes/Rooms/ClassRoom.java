...
public class ClassRoom extends AbstractRoom {
    ...
    private final int highMaxCapacity = 30;
     ...
     */
    public ClassRoom(int roomID, String roomName, String roomBuilding, int maxCapacity, boolean tavle, boolean prosjektor) {
        super(roomID, roomName, roomBuilding, RoomType.CLASSROOM, tavle, prosjektor);
